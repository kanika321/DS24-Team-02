...
#Root directories -> Modify this to run the code
...
#2MHz parquet file paths for acoustic data
...
#100KHz parquet file paths for spindle current data
...
acoustic_chunk_size = int(2 * 10**6)  
spindle_chunk_size = int(100 * 10**3)  
...
# Process NOK spindle current files
...
# Process OK spindle current files
...
output_csv_path = r"../Feature_Extraction/feature_list_combined.csv"
